  ...
  while (true) {
    ...
    try {
      ...
      const lines = [
        ...
        "",
        section("⏱ 时间信息"),
        kv("蜡烛窗口剩余:", `${timeColor}${fmtTimeLeft(timeLeftMin)}${ANSI.reset}`),
        settlementLeftMin !== null ? kv("市场结算剩余:", `${polyTimeLeftColor}${fmtTimeLeft(settlementLeftMin)}${ANSI.reset}`) : null,
        "",
        sepLine(),
        "",
        section("📊 技术分析"),
